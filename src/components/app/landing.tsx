...
function StatsSection() {
  const stats = [
    ...
    {
      label: 'Uptime ("uptime", this is all local only)',
      value: 99.9,
      suffix: '%',
      icon: Activity,
    },
  ...
  const features = [
    {
      ...
      description:
        'Create powerful Discord commands with our intuitive drag-and-drop interface. No coding required!',
    ...
    },
    {
      ...
      description:
        'Streamline member onboarding and management with automated role assignment and welcome systems.',
    ...
    },
    {
      ...
      description:
        'Make your bot truly yours with custom themes, colors, and personalized experiences.',
        ...
        <div className='container mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-discord-text max-w-4xl mx-auto leading-relaxed'>
              From visual command building to advanced analytics, Spatium
              provides all the tools you need to create engaging Discord
              experiences that your community will love.
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32'>
            ...
            >
              ...
              <p className='text-discord-text text-xl mb-10 leading-relaxed'>
                Our revolutionary visual interface lets you create sophisticated
                bot commands without writing a single line of code. Connect
                blocks, set conditions, and deploy instantly to your Discord
                server.
              </p>
              ...
              <div className='mt-10 space-y-4'>
                ...
                >
                  <Link href='/playground'>
                    <Button
                      variant='outline'
                      className='discord-button-outline text-lg px-8 py-4 rounded-xl border-2 hover:bg-discord-blurple/10 transition-all duration-300'
                    >
                      See it yourself
              ...
              <div className='bg-gradient-to-br from-discord-darker to-discord-dark rounded-3xl p-10 border border-discord-border shadow-2xl backdrop-blur-sm'>
                <div className='bg-discord-dark rounded-2xl p-8 mb-6 border border-discord-border/50'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <span className='ml-4 text-discord-text text-sm'>
                      Command Builder
                    </span>
                  </div>
                  <div className='space-y-4'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
            ...
            >
              ...
              <h3 className='text-4xl md:text-5xl font-black text-white mb-8 leading-tight'>
                ...
                <br />
                <span className='text-discord-green glow-text'>
                  Powerful Insights
                </span>
              </h3>
              <p className='text-discord-text text-xl mb-10 leading-relaxed'>
                Get detailed analytics about your server activity, member
                engagement, and growth trends. Make data-driven decisions to
                improve your community and boost engagement.
              </p>
              <div className='space-y-4'>
                {[
