...
function MetricCard({ metric, index }: { metric: any; index: number }) {
  ...
  const getTrendIcon = (change: string) => {
    if (change.startsWith('+')) return <ArrowUpRight className="w-4 h-4 text-green-500" />
    if (change.startsWith('-')) return <ArrowDownRight className="w-4 h-4 text-red-500" />
      ...
      {chartData.map((item, index) => (
        ...
        >
          ...
          {hoveredBar === index && (
            ...
            >
              <div className="text-white font-bold text-sm">{item.messages} messages</div>
            ...
            <div className="p-8 space-y-12">
                    ...
                    >
                        ...
                        <Card className="discord-card border-2 border-discord-border/50 hover:border-discord-border transition-all duration-300">
                            ...
                            <CardContent className="p-6 space-y-6">
                                {[
                                    { label: "Online Members", value: "342", icon: Users, color: "green" },
                                    { label: "Messages/Hour", value: "156", icon: MessageSquare, color: "blue" },
                                    { label: "Commands/Hour", value: "23", icon: Zap, color: "purple" },
                                    { label: "New Joins Today", value: "8", icon: TrendingUp, color: "orange" },
                                ].map((stat, index) => (
                                    <motion.div
                                        key={index}
                                        initial={{ opacity: 0, x: -20 }}
                                    ...
                                    >
                                        ...
                                        <span className={`font-bold text-${stat.color}-400 text-lg`}>
                                            {stat.value}
                                        </span>
                                    </motion.div>
                                ))}
                                ...
                                {[
                                    ...
                                    >
                                        <div className="flex items-center justify-between text-sm">
                                            ...
                                            <span className="text-discord-text">{channel.messages} msgs</span>
                                        </div>
                ...
                <section>
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-black text-white mb-2">
                            COMMUNITY <span className="text-discord-purple glow-text">INSIGHTS</span>
                        </h2>
                        <p className="text-discord-text text-lg">Discover patterns and opportunities for growth</p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                value: "7-9 PM EST",
                                description: "Your community is most active during evening hours",
                                icon: Clock,
