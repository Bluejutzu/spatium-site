...
function FeatureCard({ 
  ...
  return (
    ...
    >
      <Card className="discord-card h-full cursor-pointer group hover:border-discord-border-hover transition-all duration-500 relative overflow-hidden border-2 border-discord-border/50 hover:border-discord-blurple/50">
