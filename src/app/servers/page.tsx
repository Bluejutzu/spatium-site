...
const serverFeatures = [
  {
    ...
    description: "Deep insights into member engagement, growth patterns, and community health metrics.",
    accent: "discord-blurple",
  },
  {
    icon: Shield,
    title: "SECURITY FORTRESS",
    description: "Multi-layered protection with automated moderation and threat detection systems.",
    accent: "discord-green",
  },
  {
    icon: Settings,
    title: "TOTAL AUTOMATION",
    description: "Streamline operations with intelligent workflows and custom command systems.",
    accent: "discord-yellow",
  },
  {
    icon: Users,
    title: "MEMBER MANAGEMENT",
    description: "Sophisticated onboarding, role management, and engagement tracking tools.",
    accent: "discord-red",
  },
]
...
export default function ServersPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-discord-dark">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold mb-2 text-white font-minecraft">AUTHENTICATION REQUIRED</h2>
          <p className="text-discord-text">Please sign in to view your servers</p>
        </div>
      </div>
    )
  }
  ...
  const totalOnline = servers?.reduce((acc, server) => acc + server.onlineCount, 0) || 0

  return (
    <div className="bg-discord-dark overflow-hidden font-minecraft" ref={containerRef}>
          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl font-black text-white mb-8 leading-tight tracking-tight">
                ...
                <span className="block text-discord-blurple glow-text">COMMUNITIES</span>
              </h1>
              <p className="text-xl md:text-2xl text-discord-text max-w-4xl mx-auto mb-12 leading-relaxed font-medium">
                ...
                <br />
                <span className="text-white font-bold">enterprise-grade precision and control.</span>
              </p>
            </motion.div>
              ...
              <Card className="discord-card border-2 border-white/10 w-full max-w-6xl">
                <CardHeader className="border-b border-discord-border p-8">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <CardTitle className="text-2xl font-bold text-white tracking-wide">ACTIVE SERVERS</CardTitle>
                ...
                <CardContent className="p-8">
                  {servers && servers.length > 0 ? (
                    ...
                    >
                      ...
                      <h3 className="text-3xl font-bold text-white mb-4 font-minecraft">NO SERVERS DETECTED</h3>
                      <p className="text-discord-text mb-8 max-w-2xl mx-auto text-lg">
                        Your empire awaits expansion. Add our bot to your Discord servers to begin managing your
                        communities with enterprise-grade tools and analytics.
                      </p>
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          <a href={DISCORD_INVITE_URL} target="_blank" rel="noopener noreferrer">
                            <Button size="lg" className="discord-button-primary text-lg px-8 py-4">
                        ...
                        <div className="text-discord-text space-y-2">
                          ...
                          <p className="text-sm">
                            Ensure you have administrator permissions in your Discord server before adding the bot.
                          </p>
                        </div>
                      </div>
                    </motion.div>
          ...
          <div className="w-full max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-discord-text max-w-3xl mx-auto">
                Real-time insights into your Discord empire's reach, engagement, and growth across all managed
                communities.
              </p>
            </motion.div>
                  ...
                  >
                    <Card className="discord-card border-2 border-white/10 h-full">
                      <CardContent className="p-8 text-center">
                        ...
                        <h3 className="text-lg font-bold text-white mb-2 tracking-wide">{stat.title}</h3>

                        <div className={`text-5xl font-black text-${stat.accent} mb-4 glow-text`}>
                          <AnimatedCounter end={stat.value} />
                        </div>

                        <p className="text-discord-text mb-3">{stat.description}</p>

                        <Badge className={`bg-${stat.accent}/20 text-${stat.accent} border-${stat.accent}/30`}>
                  ...
                  >
                    <Card className="discord-card h-full">
                      <CardContent className="p-6 text-center">
                        ...
                        <h4 className="text-sm font-bold text-white mb-2 tracking-wide">{feature.title}</h4>
                        <p className="text-xs text-discord-text leading-relaxed">{feature.description}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
        ...
        <section className="min-h-screen flex items-center justify-center py-20">
          <div className="w-full max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-discord-text max-w-3xl mx-auto">
                Follow these steps to add our bot to your Discord servers and unlock the full potential of your
                communities.
              </p>
            </motion.div>
                ...
                {[
                  ...
                  >
                    <Card className="discord-card h-full text-center">
                      <CardContent className="p-8">
                        <div className={`text-6xl font-black text-${step.accent}/20 mb-4`}>{step.step}</div>
                        ...
                        <motion.div
                          ...
                          transition={{ type: "spring", stiffness: 400, damping: 17 }}
                        >
                          <step.icon className={`h-8 w-8 text-${step.accent}`} />
                        </motion.div>

                        <h3 className="text-xl font-bold text-white mb-4 tracking-wide">{step.title}</h3>
                        <p className="text-discord-text leading-relaxed">{step.description}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
