...
export function DashboardContent({ serverId }: DashboardContentProps) {
  ...
  const serverData = useQuery(api.discord.getServerMetrics, serverId ? { serverId } : "skip")
  const alerts = useQuery(api.discord.getServerAlerts, serverId ? { serverId } : "skip")
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setRealTimeData((prev) => ({
        ...
        commandsPerHour: Math.floor(Math.random() * 100) + 50,
      }))
    }, 5000)
  ...
  const onlineMembers = serverData?.server?.onlineCount || realTimeData.onlineUsers
  ...
  return (
    <div className="bg-discord-dark min-h-screen font-minecraft">
      ...
      <div className="relative z-10 flex flex-col">
        {/* Floating Header */}
        <FloatingHeader title={serverData?.server?.name || "Gaming Community"} />

        {/* Main Dashboard Content with proper top margin */}
            ...
            <div className="text-center max-w-6xl mx-auto">
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                ...
                <h1 className="text-5xl md:text-7xl font-black text-white mb-8 leading-tight tracking-tight">
                  ...
                  <span className="block text-discord-blurple glow-text">CONTROL HUB</span>
                </h1>
                ...
                <p className="text-xl md:text-2xl text-discord-text max-w-4xl mx-auto mb-12 leading-relaxed font-medium">
                  ...
                  <br />
                  <span className="text-white font-bold">real-time insights and enterprise-grade tools.</span>
                </p>
                ...
                <div className="grid md:grid-cols-4 gap-6 mb-12">
                  {[
                    ...
                    },
                    {
                      ...
                      growth: `${Math.round((onlineMembers / totalMembers) * 100)}% online`,
                    },
                    {
                      title: "MESSAGES/MIN",
          ...
          {alerts && alerts.length > 0 && (
            ...
            >
              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-white mb-6 font-minecraft tracking-wide">SYSTEM ALERTS</h2>
                {alerts.map((alert) => (
                  <Card
                    key={alert._id}
                    className={`border-l-4 ${alert.type === "error"
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4">
                        <AlertTriangle
                          className={`h-6 w-6 ${alert.type === "error"
                            ? "text-red-400"
                            : alert.type === "warning"
                              ? "text-orange-400"
                              : "text-blue-400"
                        ...
                        />
                        <div>
                          <p className="font-bold text-white text-lg">{alert.title}</p>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {dashboardFeatures.map((feature, index) => (
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 400, damping: 17, duration: 0.6, delay: 0.6 + index * 0.1 }}
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                >
                    ...
                    {serverData?.commands?.slice(0, 5).map((command, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p className="text-white font-medium">/{command.commandName} executed</p>
                          <p className="text-xs text-discord-text">
                            {new Date(command.timestamp).toLocaleTimeString()} • {command.executionTime}ms
                          </p>
                        </div>
                      </motion.div>
                    )) || (
  ...
  return (
    <div className="bg-discord-dark min-h-screen font-minecraft">
      ...
      <div className="relative z-10">
        <FloatingHeader showSearch={false} />
        ...
        <div className="pt-32 min-h-screen flex items-center justify-center">
          ...
          >
            ...
            <p className="text-xl text-discord-text max-w-2xl mx-auto mb-8">
              ...
              <br />
              <span className="text-white font-bold">unleash the full power of your Discord empire.</span>
            </p>
