...
const getCategoryColor = (blocks: string) => {
  try {
    ...
    if (blockTypes.includes("add-role") || blockTypes.includes("remove-role")) return "roles"
    if (blockTypes.includes("kick-member") || blockTypes.includes("ban-member")) return "moderation"
    if (blockTypes.includes("create-channel") || blockTypes.includes("delete-channel")) return "channels"
    if (blockTypes.includes("move-member") || blockTypes.includes("mute-member")) return "voice"
...
export default function CommandsPage({ params }: any) {
  ...
  const handleEditCommand = (commandId: string) => {
    router.push(`/dashboard/${serverId}/commands/builder?commandId=${commandId}`)
  }
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <h1 className="text-6xl font-black text-white tracking-tight">COMMANDS</h1>
            </div>
                        ...
                        <CardContent className="pt-0 pb-6 relative z-10">
                          ...
                          <div className="space-y-2 mb-6 text-xs">
                            <div className="flex justify-between text-discord-text/90">
                              ...
                              <span className="font-semibold">{formatDate(command.creationTime)}</span>
                            </div>
                            {command.lastUpdateTime && (
                              <div className="flex justify-between text-discord-text/90">
                                <span className="font-medium">Updated:</span>
                                <span className="font-semibold">{formatDate(command.lastUpdateTime)}</span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent className="bg-discord-darker border-discord-border shadow-2xl">
                                <AlertDialogHeader>
                                  <AlertDialogTitle className="text-white text-xl">Delete Command</AlertDialogTitle>
