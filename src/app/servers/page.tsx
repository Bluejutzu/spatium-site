...
export default function ServersPage() {
  ...
  return (
    ...
    >
      ...
      {/* Enhanced Header */}
      <header className='relative z-50 border-b border-discord-border bg-discord-dark/80 backdrop-blur-xl sticky top-0'>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div>
                  ...
                  <p className='text-sm text-discord-text'>
                    Manage your communities with precision
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Server Management Section - Now First */}
              ...
              {servers && servers.length > 0 ? (
                  ...
                  {servers.map((server, index) => (
                    ...
                    >
                      <Link href={`/dashboard/${server.serverId}`}>
                        <Card className='discord-card hover:border-discord-border-hover transition-all duration-300 cursor-pointer group'>
                ...
                >
                  ...
                  <p className='text-discord-text mb-8 max-w-2xl mx-auto text-lg'>
                    Your empire awaits expansion. Add our bot to your Discord
                    servers to begin managing your communities with
      ...
      <section className='relative min-h-screen flex items-center justify-center py-20 bg-discord-darker/50'>
        <div className='container mx-auto px-6'>
          <motion.div
            className='text-center mb-16'
            initial={{ opacity: 0, y: 30 }}
