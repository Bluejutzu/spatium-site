...
import { Search, Bell, Settings, BarChart3, Users, MessageSquare, Zap, Command, ChevronDown } from "lucide-react"
...
export function FloatingHeader({ showSearch = true, title }: FloatingHeaderProps) {
                ...
                <div className="px-6 py-4">
                    <div className="flex items-center justify-between">
                                ...
                                <DropdownMenuContent className="w-56 bg-discord-dark border-white/20">
                                    {quickActions.map((action) => (
                                        ...
                                        >
                                            ...
                                            <kbd className="text-xs bg-white/10 px-1.5 py-0.5 rounded">{action.shortcut}</kbd>
                                        </DropdownMenuItem>
                                    ))}
                        ...
                        {showSearch && (
                            ...
                            >
                                ...
                                <div className="absolute right-3 flex items-center gap-1">
                                    <kbd className="text-xs bg-white/10 text-discord-text px-1.5 py-0.5 rounded">⌘K</kbd>
                                </div>
                            </motion.div>
                        )}
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* Settings */}
                            <Button variant="ghost" size="icon" className="text-discord-text hover:text-white hover:bg-white/5">
                            ...
                            <UserButton
                                appearance={{
                                    elements: {
                                        avatarBox: "h-8 w-8 ring-2 ring-discord-blurple/20 hover:ring-discord-blurple/40 transition-all",
                                    },
                                }}
                            />
                        </div>
