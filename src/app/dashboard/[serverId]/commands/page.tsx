...
const getCategoryColor = (blocks: string) => {
  try {
    ...
    if (blockTypes.includes('send-message'))
    ...
    if (blockTypes.includes('create-webhook'))
    ...
    if (blockTypes.includes('unq-variable'))
              ...
              <Card className='bg-gradient-to-br from-discord-darker/80 to-discord-dark/80 border-discord-border backdrop-blur-sm hover:border-discord-blurple/50 transition-all duration-300'>
                <CardContent className='p-4'>
                  <div className='flex items-center justify-between'>
                    <div>
                      <p className='text-sm text-discord-text font-medium'>
                        Total Commands
                      </p>
                              ...
                              <AlertDialogContent className='bg-discord-darker border-discord-border'>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription className='text-discord-text'>
                                    ...
                                    "/{command.name}"? This action cannot be
                                    undone and will permanently remove the
                                    command and all its configurations.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
