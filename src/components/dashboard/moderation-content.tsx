  ...
  return (
    ...
    >
      ...
      <div className='w-24 flex items-center gap-2'>
        <div className={`p-1 rounded ${getActionColor(action.action)}`}>
      ...
      <div className='flex items-center gap-3 min-w-[180px]'>
        <Avatar className='h-8 w-8'>
          {isUserLoading ? (
            ...
            <AvatarImage
              src={
                getAvatarUrl(userProfile.id, userProfile.avatar) ||
                '/placeholder.svg'
              }
        ...
        <div>
          <div className='font-semibold text-white text-sm'>
            {isUserLoading
              ? 'Loading...'
              : userProfile?.username || action.userId}
          </div>
          <div className='text-discord-text text-xs'>
            ID: {action.userId.slice(-8)}
          </div>
        </div>
      </div>
      ...
      <div className='w-40 flex items-center gap-2'>
        <Avatar className='h-6 w-6'>
          {isCloserLoading ? (
            ...
            <AvatarImage
              src={
                getAvatarUrl(closerProfile.id, closerProfile.avatar) ||
                '/placeholder.svg'
              }
        ...
        <span className='text-discord-text text-xs truncate'>
          {isCloserLoading
            ? 'Loading...'
            : closerProfile?.username || 'Well idk'}
        </span>
      </div>
      ...
      <div className='w-40 flex items-center gap-2'>
        <Avatar className='h-6 w-6'>
          {isModLoading ? (
            ...
            <AvatarImage
              src={
                getAvatarUrl(modProfile.id, modProfile.avatar) ||
                '/placeholder.svg'
              }
        ...
        <span className='text-discord-text text-xs truncate'>
          {isModLoading
            ? 'Loading...'
            : modProfile?.username || action.moderator}
        </span>
      </div>
...
function ModerationActionDetails({
  ...
  useEffect(() => {
    ...
    const userIds = [action.userId, action.moderator, action.closedBy].filter(
      Boolean
    ) as string[];
      ...
      <div className='mb-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6'>
          ...
          <div className='flex flex-col gap-2'>
            <span className='text-xs text-discord-text uppercase tracking-wide'>
              ID
            </span>
          ...
          <div className='flex flex-col gap-2'>
            ...
            {action.state === 'Done' ? (
              <span className='text-white font-semibold pt-2'>
                {action.duration
                  ? `Expired on ${new Date(action.duration).toLocaleString()}`
                  : 'Permanent'}
              </span>
            ) : (
              <>
                  ...
                  <div className='flex items-center gap-3'>
                    <Avatar className='h-8 w-8'>
                      {closerInfo.isLoading ? (
                        ...
                        <AvatarFallback>
                          {closerInfo.username.charAt(0).toUpperCase()}
                        </AvatarFallback>
                      )}
                    </Avatar>
                    <div className='flex flex-col'>
  ...
  return (
    <div className='flex-1 overflow-auto bg-discord-dark'>
        ...
        <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6'>
          ...
          >
            ...
            <p className='text-discord-text text-lg'>
              Monitor and manage server moderation activities
            </p>
          </motion.div>
      ...
      <div className='p-8 space-y-10'>
        ...
        <p className='text-discord-text text-center text-sm'>
          Pretty lonely down here...
        </p>
      </div>
    </div>
  );
